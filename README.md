...
| `site.js` | Mobile menu toggle and the "Copy BibTeX" buttons | rarely; without it the page still reads completely (navigation stays expanded; BibTeX buttons are inert) |
...
- **Publication list.** The site and CV list *verified* records; Google Scholar shows additional M.S.-era conference entries that are not printed until their proceedings records are confirmed.
